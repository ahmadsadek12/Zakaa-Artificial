...
import { Package, Check, X, DollarSign, Unlock, Menu, X as XIcon } from 'lucide-react'
    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">Browse and purchase add-on subscriptions</p>
        </div>
