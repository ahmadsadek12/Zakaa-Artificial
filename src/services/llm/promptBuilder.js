...
- get_services() - ⚠️ ONLY use when customer EXPLICITLY asks for menu ("show menu", "what do you have?", "menu please"). DO NOT use when: (1) customer is ordering items - use add_service_to_cart() instead; (2) customer is managing their order ("I want 3 trios", "remove 3 of the 6"); (3) customer is providing delivery info ("I want it delivered", addresses); (4) customer has items in cart and is in order flow; (5) customer is confirming or scheduling orders. If menu was already shown, don't show again unless explicitly requested. ⚠️ CRITICAL: If customer has items in cart OR is providing delivery info, DO NOT show menu - they're ordering, not browsing.
